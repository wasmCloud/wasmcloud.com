...
wasmCloud's wRPC protocol is a (just as it sounds) an RPC protocol for dynamically composing distributed WebAssembly components at runtime over the lattice. 
