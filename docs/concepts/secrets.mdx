...
![diagram of secret flow when starting provider with secret](../../static/img/start-provider-with-secret.png)
...
![diagram of secret flow when publishing link with secret](../../static/img/publish-link-with-secret.png)
...
![diagram of secret flow when fetching secret within component](../../static/img/fetch-secret-within-component.png)
