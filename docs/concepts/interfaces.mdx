...
In wasmCloud, [components](/docs/1.0/concepts/components) and [providers](/docs/1.0/concepts/providers) communicate through **interfaces**, sometimes called capabilities.
...
While similar frameworks and languages like [gRPC][grpc] and [Smithy][smithy] are meant to perform over network boundaries, WIT is *in-process*, and performs at near-native speed.
:::
