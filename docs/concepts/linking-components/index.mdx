...
![Composition](../../../static/img/composed-component.gif)
...
![Linked at runtime](../../../static/img/runtime-linked.png)
...
![Diagram of wasmCloud environment](../../../static/img/linking-components.png)
