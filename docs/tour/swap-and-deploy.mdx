...
In our previous tutorials, we started a developer loop with `wash dev` and added two [**interfaces**](/docs/concepts/interfaces.mdx) (`wasi:logging` and `wasi:keyvalue`) to our application.
...
In the process, we'll look under the hood and see how [**capabilities**](/docs/concepts/capabilities.mdx) work.
...
For more on using interfaces with your native language toolchain and adding new interfaces to an application, see the [Interfaces](/docs/developer/interfaces/creating-an-interface) page in our [Developer Guide](/docs/category/developer-guide).
