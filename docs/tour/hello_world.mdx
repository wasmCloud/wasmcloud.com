...
- a **NATS** server to manage communications b/w application components
- a **wadm** process which monitors the [lattice](/docs/reference/glossary#lattice) and maintains the state of managed deployments
