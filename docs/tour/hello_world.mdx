...
- a [**wadm**](/docs/category/managed-application-deployment-wadm) process which monitors the [lattice](/docs/reference/glossary#lattice) and maintains the state of managed deployments
