...
Components and providers include a version (and other metadata) at build-time, defined in the component or provider's [config file](/docs/reference/config#common-config). This metadata can be inspected using the [CLI](/docs/cli/inspect).
