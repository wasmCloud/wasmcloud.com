...
wasmCloud provides all the tools to build, deploy, and manage complex distributed applications. In addition to the [host](/docs/concepts/hosts), wasmCloud also has a [CLI](/docs/cli/), a [UI](/docs/cli/#wash-ui), and a [deployment manager](/docs/ecosystem/wadm/).
...
Components and providers include a version (and other metadata) at build-time, defined in the component or provider's [config file](/docs/reference/config#common-config). This metadata can be inspected using the [CLI](/docs/cli/#wash-inspect).
