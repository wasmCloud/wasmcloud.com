...
The most common thing application developers will do is build actors. Actors encompass pure business logic, and only communicate with non-functional requirements through capability providers and abstract [interfaces](/docs/interfaces).
...
2. [Check it](/docs/interfaces/tips/lint-validate/) with `wash lint` and `wash validate`
