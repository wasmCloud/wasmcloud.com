...
Then move `wash` to `/usr/local/bin` to add it to your PATH (this assumes you ran the script from your home directory — adjust the source path if you ran it elsewhere):
