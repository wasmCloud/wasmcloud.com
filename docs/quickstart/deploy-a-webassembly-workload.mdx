...
about: WebAssembly
mentions: [Kubernetes, wasmCloud, wash, Rust]
...
![Blobby Storage Manager UI showing an uploaded file with Copy Link, Download, and Delete buttons](../images/blobby-ui.webp)
