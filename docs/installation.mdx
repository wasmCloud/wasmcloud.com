...
We will guide you through installation of `wash`, the wasmCloud Shell, which gives you the tools to
...
That's it! Now that `wash` is installed, let's move on to [Getting
started](/docs/getting-started.mdx)
