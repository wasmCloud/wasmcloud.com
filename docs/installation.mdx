...
Verify that `wash` is installed properly with:

```bash
wash --help
```

If wash is property installed, you will see a printout of all available commands and short descriptions for each.
