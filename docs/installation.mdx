...
- The most current pre-release version of **`wash-cli`** is **0.27.0-alpha.2**, which is available [available on GitHub](https://github.com/wasmCloud/wasmCloud/releases/tag/wash-cli-v0.27.0-alpha.2)
