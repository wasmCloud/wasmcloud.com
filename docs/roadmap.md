...
1. **Leverage as many WebAssembly standards as possible (e.g. WASI, Wasm components, wasi-cloud, etc)**
...
1. Leverage cloud-native standards where possible (e.g. OAM, OCI, CloudEvents, etc.)
