...
about: wasmCloud
mentions: [NATS, wadm, Kubernetes, WebAssembly]
...
![wasmCloud v1 architecture](./images/v1-architecture.webp)
...
![wasmCloud v2 architecture](./images/v2-architecture-migration.webp)
...
![v1 to v2 concept migration map](./images/concept-mapping.webp)
...
![Capability provider migration paths](./images/capability-migration.webp)
...
![v2 security and permissions model](./images/security-model.webp)
...
![wasmCloud CRD hierarchy](./images/crd-hierarchy.webp)
...
![v2 workload scheduling flow](./images/scheduling-flow.webp)
...
You can find a [basic example](https://github.com/wasmCloud/wasmCloud/tree/main/crates/wash-runtime#usage) in the `wash-runtime` repository.
