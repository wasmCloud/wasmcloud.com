...
about: TypeScript
mentions: [WebAssembly, wasmCloud, WASI, NATS]
...
3. **Import functions in TypeScript** using the exact WIT interface name as the import path. TypeScript resolves the import against the ambient module declarations in `generated/types/`.
