...
Services are developed using the `wash dev` command. You can find a complete service example at [`wash/examples/cron-service`](https://github.com/wasmCloud/wasmCloud/tree/main/examples/cron-service).
