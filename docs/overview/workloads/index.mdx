...
about: WebAssembly
mentions: [wasmCloud, wash, Kubernetes, WASI]
...
![Workload diagram](../../images/workload-diagram.webp)
...
Workloads are defined according to the [wasmCloud runtime's Workload API](https://github.com/wasmCloud/wasmCloud/blob/main/proto/wasmcloud/runtime/v2/workload.proto). For most users, this means defining the workload in a Kubernetes manifest with the [`WorkloadDeployment` custom resource](../../kubernetes-operator/crds.mdx#workloaddeployment). 
