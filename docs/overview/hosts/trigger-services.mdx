...
- **`wasmcloud:host/workload-call`** (added in wasmCloud 2.7.0, host component plugins): invoke interfaces that workloads export, targeting the current caller implicitly or an explicitly opened workload.
