...
Wasmtime serves a similar role to a container runtime such as containerd on a Kubernetes node, but don't put too much weight on the analogy: components are not containers, and using a dedicated WebAssembly runtime facilitates component-specific patterns such as composition. 
:::
