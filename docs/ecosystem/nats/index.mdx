...
![NATS queue subscription diagram](../../../static/img/nats-queue-subscription.png)
...
* You can [use the `wash` CLI to open a WebSocket port](/docs/cli/up#--nats-websocket-port) utilizing [WebSocket support in NATS](https://docs.nats.io/running-a-nats-service/configuration/websocket).   
