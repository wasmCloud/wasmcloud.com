...
[**Software Bills of Materials (SBOMs)**](https://edu.chainguard.dev/open-source/sbom/what-is-an-sbom/) describe the set of software dependencies (sometimes called the "software supply chain") used to build an application. 
...
* [`grype`](https://github.com/anchore/grype?tab=readme-ov-file#installation) (and optionally [`trivy`](https://github.com/aquasecurity/trivy?tab=readme-ov-file#get-trivy)) for vulnerability scanning
