...
This configuration will allow `wash` to download binaries through the proxy. For authenticating to private registries, see the [Registries](./registries) guide.
