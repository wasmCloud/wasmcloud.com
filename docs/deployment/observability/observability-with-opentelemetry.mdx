...
It is also possible to enable and overwrite endpoints for only specific signals&mdash;see the pages for [traces](/docs/1.0/deployment/observability/tracing), [logs](/docs/1.0/deployment/observability/logs), and [metrics](/docs/1.0/deployment/observability/metrics) for more details. 
