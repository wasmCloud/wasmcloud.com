...
- **Source**: [`wasmCloud/typescript — templates/http-filesystem-service-hono`](https://github.com/wasmCloud/typescript/tree/v2/templates/http-filesystem-service-hono)
