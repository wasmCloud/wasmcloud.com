...
need before **how** to meet those needs_. Systems developed using IDD - especially
distributed systems - are more _loosely coupled, robust and maintainable_.

Regular WebAssembly modules operate in a completely isolated sandbox, meaning
that they can perform logical operations with no access to system resources
...
services like key-value stores, HTTP servers, HTTP clients, message brokers,
and many more.
As you make your way through the fundamentals section you'll see many
