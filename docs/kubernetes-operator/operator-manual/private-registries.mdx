...
For example, with version `2.0.0`, the images are:

- `ghcr.io/wasmcloud/runtime-operator:2.0.0`
- `ghcr.io/wasmcloud/runtime-gateway:2.0.0`
- `ghcr.io/wasmcloud/wash:2.0.0`
...
images:
  ...
  - source: ghcr.io/wasmcloud/runtime-operator:2.0.0
    destination: myregistry/wasmcloud/runtime-operator:2.0.0
  - source: ghcr.io/wasmcloud/runtime-gateway:2.0.0
    destination: myregistry/wasmcloud/runtime-gateway:2.0.0
  - source: ghcr.io/wasmcloud/wash:2.0.0
    destination: myregistry/wasmcloud/wash:2.0.0
...
| `runtime.image.tag` | `2.0.0` | Runtime host image tag |
