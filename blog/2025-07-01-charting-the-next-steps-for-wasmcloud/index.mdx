...
about: wasmCloud
mentions: [WebAssembly, wash, Cosmonic, Rust]
---
...
![Diagram, left == multiple providers multiple components on a host, right == multiple components one provider per host. Moar dense.](./images/platform-application-diagram.webp)
