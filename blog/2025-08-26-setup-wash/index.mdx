---
title: "GitHub Action for Wasm Dev with wash"
authors: [ricochet]
...
about: wash
mentions: [WebAssembly, wasmCloud, TypeScript, Cosmonic]
---
...
![GitHub commit with 47000 lines removed](./images/47000-lines.webp)
...
![cargo compiling](./images/cargo-compiling.webp)

![first run takes 8 minutes!](./images/setup-wash-first-run.webp)
...
![setup-wash from cache is 1s](./images/setup-wash-from-cache.webp)
...
![draft a release tip for marketplace](./images/draft-a-release.webp)
...
![setup-wash-action in the marketplace](./images/setup-wash-marketplace.webp)
