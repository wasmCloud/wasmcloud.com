...
title: 'Wasm Components Extend K8s to Multi-Cloud and Edge'
image: './images/next-wave-header.webp'
date: "2024-07-08"
...
about: WebAssembly
mentions: [Kubernetes, wasmCloud, CNCF, Rust]
---
...
![multi-language diagram](./images/compile.webp)
...
![K8s & wasmCloud comparison diagram](./images/k8s-wasmCloud-v2.webp)
...
![deployment diagram](./images/regions.webp)
