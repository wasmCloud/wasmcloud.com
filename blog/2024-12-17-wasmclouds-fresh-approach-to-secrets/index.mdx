...
about: wasmCloud
mentions: [WebAssembly, CNCF, Cosmonic, Kubernetes]
---
...
As Brooks describes, we wanted a [better approach](https://github.com/wasmCloud/wasmCloud/blob/main/adr/0019-secrets.md) to the status quo. One that leverages the NATS-powered lattice to deliver true encryption, and avoids storing secrets on the [wasmCloud host](/docs/v1/concepts/hosts/) in any form that would be accessible to anything other than the component or provider requesting them.
...
- [**Further reading**](/blog/2024-12-17-wasmclouds-fresh-approach-to-secrets/#further-reading): Discussion of useful resources like our [secrets documentation](https://wasmcloud.com/docs/v1/concepts/secrets/).
...
![secrets-in-wasmcloud.webp](./images/secrets-in-wasmcloud.webp)
...
![secrets-in-wasmcloud-concept.webp](./images/secrets-in-wasmcloud-concept.webp)
...
![secrets-for-providers.webp](./images/secrets-for-providers.webp)
...
![secrets-for-components.webp](./images/secrets-for-components.webp)
...
![secrets-wit.webp](./images/secrets-wit.webp)
