...
Providing support for Kubernetes Secrets is particularly powerful, since it means that teams [running wasmCloud on Kubernetes](/blog/how-to-run-webassembly-components-on-kubernetes-with-wasmcloud) can immediately use their existing secrets systems with wasmCloud applications. 
