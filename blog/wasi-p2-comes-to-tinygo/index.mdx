---
title: "WASI P2 comes to TinyGo: Write idiomatic Go and compile to a Wasm component"
author: "Eric Gregory"
image: '/img/tinygo-wasip2.png'
date: 2024-07-02T10:00:00-06:00
categories: ['webassembly', 'wasmcloud', 'go', 'golang', 'wasi', 'components']
draft: false
---

![Write idiomatic Go and compile to a Wasm component](/img/tinygo-wasip2.png)
...
Do you see clunky calls to WASI interfaces? Do you see WASI at all? Nope, that's just [a bit](https://github.com/itchyny/gojq/blob/main/normalize.go) of [**`go-jq`**](https://github.com/itchyny/gojq), the widely-used Go implementation of the JSON processor `jq`. 
