---
title: "Adopting SPIFFE for Wasm Workload Identity"
...
about: WebAssembly
mentions: [wasmCloud, CNCF, Kubernetes, capabilityBasedSecurity]
---

import BedaTweet from './images/spiffe-beda-twitter.webp';
