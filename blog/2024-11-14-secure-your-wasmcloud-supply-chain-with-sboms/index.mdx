---
title: "Secure your wasmCloud supply chain with Software Bills of Materials (SBOMs)"
authors: [ericgregory]
...
![Secure your wasmCloud supply chain with Software Bills of Materials (SBOMs)](./images/wasmcloud-sboms.webp)

Software supply chain security is critical for enterprises, and **Software Bills of Materials (SBOMs)** are an essential element of every organization's security framework. 
