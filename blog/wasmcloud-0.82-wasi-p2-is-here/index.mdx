---
title: "wasmCloud 0.82: WASI P2, OTEL logging, and more"
date: 2024-02-20T10:00:00-07:00
author: "Eric Gregory"
author_profile: "https://www.linkedin.com/in/egregory04/"
image: "./082.png"
description: "We’re proud to announce wasmCloud 0.82&mdash;the last stop on the road to our 1.0 milestone. For this tutorial, we'll use Python as an example. This release brings WASI Preview 2 support, OpenTelemetry logging, and more."
tags: ['wasmCloud', 'WASI', 'OpenTelemetry', 'WebAssembly', 'Wasm']
draft: false

---

![wasmCloud 0.82 releases with WASI P2 support](./082.png)
...
* Full and stable support for WASI P2 APIs 
...
WebAssembly components&mdash;portable, interoperable, and composable&mdash;are the future of Wasm artifacts, and with WASI P2, that future is here. Components are ideally suited to wasmCloud's design philosophy, and we're all-in: as of 0.82, the old “module + wasmbus” model is deprecated and will be removed in 1.0.  

Version 0.82 supports running both components and legacy modules, so now is the time to migrate old projects, do it with stable WASI P2 APIs, and have some fun!
