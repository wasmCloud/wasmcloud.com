...
- [**Wasmtime is bumped to version 45**](https://github.com/wasmCloud/wasmCloud/pull/5206) — Bailey notes it's the first `wasmtime` bump in a while that has required no API adaptations.
