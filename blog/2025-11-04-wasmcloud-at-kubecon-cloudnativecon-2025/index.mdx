...
about: wasmCloud
mentions: [WASI, WebAssembly, Cosmonic, BytecodeAlliance]
---
...
![Solution Showcase floor map](./images/wasmcloud-floor-map.webp)

![Project pavilion map](./images/project-pavilion-map.webp)
