...
about: wasmCloud
mentions: [OpenTelemetry, WebAssembly, WASI, Docker]
---
...
![wasmcloud host -> otel collector -> system like Grafana](../../docs/images/otel-diagram.webp)
...
![Tempo interface](./tempo.webp)

You can switch to Loki and run a query to see logs...

![Loki interface](./loki.webp)
