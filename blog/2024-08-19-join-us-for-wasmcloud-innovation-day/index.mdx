...
- **12.15 - 12.30: Fireside Chat:** Bytecode Alliance leaders [Pat Hickey](https://github.com/pchickey) and [Yoshua Wuyts](https://github.1git.de/yoshuawuyts) will join Bailey Hayes to discuss...
...
- **Customer and User Demos**
    - Akamai and the future of edge computing: join Senior Architect Doug Rodrigues to learn about Akamai's edge strategy, how computing at the edge must evolve, and the role of WebAssembly in getting there.
    - wasmCloud in Industrial IoT: MachineMetrics's Senior Data Platform Engineers [Jochen Rau](https://github.com/jocrau) and [Tyler Schoppe](https://github.com/tylerschoppe) are working with wasmCloud to drive better resource efficiency at the edge. Join to learn how and what's next for wasmCloud at MachineMetrics.
