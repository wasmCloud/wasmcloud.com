...
* Wasm-native RPC working with Go
...
Plugins for `wash` are *already* merged into wash 0.28, so you can expect to hear more about them very, very soon. 

## Wasm-native RPC&mdash;now with Go
