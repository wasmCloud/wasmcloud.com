...
With the power of components and WASI 0.2 APIs, wasmCloud makes truly portable, vendor-neutral apps&mdash;and unprecedentedly flexible developer platforms&mdash;a reality. The wasmCloud 1.0 alpha release (already pinned to WASI 0.2) is [available on GitHub](https://github.com/wasmCloud/wasmCloud/releases/tag/v1.0.0-alpha.1) right now for testing and finalization of APIs. If you like to live on the bleeding edge, you can try it out with the latest release of wash&mdash;questions and feedback are welcome and encouraged!