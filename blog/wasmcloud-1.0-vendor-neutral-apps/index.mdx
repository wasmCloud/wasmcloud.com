...
date: 2024-03-13T10:00:00-07:00
author: "Eric Gregory"
author_profile: "https://www.linkedin.com/in/egregory04/"
image: "./vendor-neutral.png"
description: "TK."
...
![Vendor-neutral apps with wasmCloud and WASI 0.2](./vendor-neutral.png)
...
With the power of components and WASI 0.2 APIs, wasmCloud makes truly portable, vendor-neutral apps&mdash;and unprecedentedly flexible developer platforms&mdash;a reality. The wasmCloud 1.0 alpha release is [available on GitHub](https://github.com/wasmCloud/wasmCloud/releases/tag/v1.0.0-alpha.1) right now.

To learn more about creating components with wasmCloud, check out the [wasmCloud Quickstart](https://wasmcloud.com/docs/tour/hello-world), or [browse the docs](https://wasmcloud.com/docs/intro) to learn more about the platform. We love questions and new community members&mdash;join the [wasmCloud Slack](https://slack.wasmcloud.com/) to be part of the conversation.