---
title: 'Better Together: Wasm Microservices on K8s'
...
![signature removal setup](./images/sigremoval-one.webp)

![signature removal result](./images/sigremoval-two.webp)
...
![link definition messaging setup](./images/linkdef-one.webp)

Next, connect the service-applier actor to the applier provider, using just the Contract ID (`cosmonic:kubernetes_applier`):

![link definition kubernetes applier setup](./images/linkdef-two.webp)
...
![link definition httpserver setup](./images/linkdef-three.webp)
