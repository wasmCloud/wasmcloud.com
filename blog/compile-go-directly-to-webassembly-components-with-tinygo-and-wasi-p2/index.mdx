...
author: "Eric Gregory"
image: '/img/compile-go-directly-to-webassembly-components-with-tinygo-and-wasip2.png'
date: 2024-07-02T10:00:00-06:00
categories: ['webassembly', 'wasmcloud', 'go', 'golang', 'wasi', 'components']
draft: false
---

![Write idiomatic Go and compile to a Wasm component](/img/compile-go-directly-to-webassembly-components-with-tinygo-and-wasip2.png)
...
![gif of component build](../../static/img/idiomatic-go-compiling-directly-to-WebAssembly-Components.gif)
