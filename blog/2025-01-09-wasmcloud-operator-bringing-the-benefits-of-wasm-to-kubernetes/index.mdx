---
title: "wasmCloud Operator: Wasm on Kubernetes"
...
about: wasmCloud
mentions: [Kubernetes, WebAssembly, WASI, ComponentModel]
---
...
![epochs-of-tech-the-next-abstraction.webp](./images/epochs-of-tech-the-next-abstraction.webp)
...
![from-laptop-to-production.webp](./images/from-laptop-to-production.webp)
...
![host-groups.webp](./images/host-groups.webp)
...
![application-manifest.webp](./images/application-manifest.webp)
...
![kubernetes-services.webp](./images/kubernetes-services.webp)
...
![secrets-integration.webp](./images/secrets-integration.webp)
