...
date: '2024-08-01'
description: 'Dotan Horovitz of Logz.io and Open Observability Talks podcast host discusses the next frontier in cloud-native evolution: WebAssembly.'
slug: webassembly-the-next-frontier-in-cloud-native-evolution
# one off blog post gets inline author
author: Dotan Horovitz
