---
title: "Bring Your Own Wasm Components to wasmCloud"
date: "2024-02-06"
authors: [ericgregory]
image: "./wasmcloud-py.webp"
description: "Run any WebAssembly component on wasmCloud, step by step. This tutorial uses Python to show how to bring your own Wasm components to the platform."
tags: ['wasmCloud', 'Python', 'WebAssembly', 'Wasm']
slug: bring-your-own-wasm-components
about: wasmCloud
mentions: [WebAssembly, Python, WASI, wash]
---

![Components written in Python on wasmCloud](./wasmcloud-py.webp)
