...
For a listing of Go component tooling, see [**Building components with Go**](/docs/v1/developer/languages/go/components). 
...
* Learn [how to build a component in Go](/docs/v1/developer/languages/go/components).
