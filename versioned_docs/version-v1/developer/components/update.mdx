...
This will watch your project's files and, whenever there's a change, recompile and update the component in the host. Try iterating through a few changes in the [Add Features](/docs/v1/tour/add-features/) section to see how it works.
