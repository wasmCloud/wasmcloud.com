...
The following sections detail ways to track down errors with specific wasmCloud components, as well as some of the most common issues we see when getting started with wasmCloud applications. It's recommended to start with the [Host Troubleshooting](/docs/v1/developer/troubleshooting/host/) guide first, as it details how to find wasmCloud's logs.

- [Host Troubleshooting](/docs/v1/developer/troubleshooting/host/)
- [Component Troubleshooting](/docs/v1/developer/troubleshooting/components/)
- [Provider Troubleshooting](/docs/v1/developer/troubleshooting/providers/)
