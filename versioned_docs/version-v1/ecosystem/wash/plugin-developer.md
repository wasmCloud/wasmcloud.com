...
components and WIT, please read our existing [developer documentation](/docs/v1/developer/components/) first.
...
variables or configuration files (or both). Every plugin is given a list of environment variables
