...
The `Undeployed` state is assigned to an application after you use the [wadm API](/docs/v1/ecosystem/wadm/api/) to put an application. This application is stored in the model store but none of the resources in the application are deployed or managed by wadm.
