...
Wasmtime is an open source WebAssembly runtime [hosted by the Bytecode Alliance](https://github.com/bytecodealliance/wasmtime) and designed for use either as part of a larger stack or as a standalone runtime, running across a variety of operating systems and architectures. Wasmtime supports the WebAssembly standard as well as the [WebAssembly System Interface (WASI)](/docs/v1/reference/glossary#webassembly-system-interface-wasi) and the [Component Model](/docs/v1/reference/glossary#the-component-model).
...
For more information, see [Linking Components](/docs/v1/concepts/linking-components/) and [Linking at Build](/docs/v1/concepts/linking-components/linking-at-build).

## Further reading

* For more information, [see the Wasmtime documentation](https://docs.wasmtime.dev/). 
* For more WebAssembly ecosystem tooling, see [Useful WebAssembly Tools](/docs/v1/ecosystem/useful-webassembly-tools/).
