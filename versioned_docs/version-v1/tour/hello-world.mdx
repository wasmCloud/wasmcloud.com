...
title: 'Hello World'
sidebar_position: 1
description: "Get started with wasmCloud: build and run your first WebAssembly component in minutes using wash."
---
...
wasmCloud enables you to **build polyglot applications** out of reusable [WebAssembly (Wasm) components](/docs/v1/concepts/components/) and **run them everywhere**&mdash;across any cloud, Kubernetes, datacenter, or edge.
...
wasmCloud supports building WebAssembly components from any language that supports the [WASI 0.2 target](/docs/v1/concepts/interfaces/#well-known-interfaces), including Go, Rust, TypeScript, and others.
