...
- Identify the [**capabilities**](/docs/v1/concepts/capabilities) your application needs. (Think common requirements like serving HTTP, storing key-value pairs, or logging.)
- Add [**interfaces**](/docs/v1/concepts/interfaces) for those capabilities.
...
:::info[Prerequisites]
This tutorial assumes you're following directly from the previous tutorial. If you don't have a "Hello world" application running with `wash dev`, complete [**Quickstart**](/docs/v1/tour/hello-world) first.
:::
