...
For more information on linking components at runtime or at build via composition, including when you might want to use each approach, see [Linking Components](https://wasmcloud.com/docs/v1/concepts/linking-components/) in the wasmCloud documentation.
