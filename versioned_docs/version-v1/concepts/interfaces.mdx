...
In wasmCloud, [components](/docs/v1/concepts/components) and [providers](/docs/v1/concepts/providers) communicate through **interfaces**: contracts that define the relationships between entities. These interfaces come in two kinds:
...
For more information on organizing an interface, see [Creating an interface](/docs/v1/developer/interfaces/creating-an-interface).
...
For more information on using WIT, see our Developer Guide page on [**Creating an interface**](/docs/v1/developer/interfaces/creating-an-interface).
...
Interface-driven development (IDD) is a development approach that focuses on defining what [capabilities](/docs/v1/concepts/capabilities) components require before the specifics of how you will meet those needs.

Systems developed using IDD&mdash;especially distributed systems&mdash;are loosely coupled, robust, and maintainable.

## Keep reading

[Continue to learn more about how the wasmCloud host](/docs/v1/concepts/hosts), or...

- Explore the Developer Guide to learn more about [creating your own interfaces](/docs/v1/developer/interfaces/creating-an-interface).
