...
In addition to the wasmCloud tooling (`wash`) and language-specific tooling described in the [wasmCloud Quickstart](/docs/v1/tour/hello-world?lang=tinygo), you will need the following tools:
