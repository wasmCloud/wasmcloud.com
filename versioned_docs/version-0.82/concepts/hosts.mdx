...
Hosts emit unstructured (text) or structured (JSON) logs. The log level and format can be configured for each host [at start time](/docs/reference/host-config.md).
