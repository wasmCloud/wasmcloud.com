...
While the OTEL collector is the recommended point of configuration for complex signal routing, there are a set of core configurations available at the level of a [wasmCloud host](https://wasmcloud.com/docs/v1/concepts/hosts).
...
While these options are typically passed as part of [host configuration](https://wasmcloud.com/docs/v1/reference/host-config), you can launch a wasmCloud observability ecosystem locally by passing environment variables to `wash up`:
