...
**Wasm Shell** (`wash` v2.x and higher) is a more tightly focused utility for WebAssembly component development, designed to be extensible via plugins and usable across the Wasm ecosystem. 
