...
In wasmCloud, [components](./workloads.mdx) communicate through interfaces, which come in two kinds:
...
![Namespace and package in a WIT file](../images/wit-package.png)
...
wasmCloud supports interfaces belonging to [WebAssembly System Interface (WASI)](https://wasi.dev/) P2 in addition to a selection of interfaces proposed for inclusion in WASI, and interfaces belonging to the wasmCloud host.

### WASI interfaces

[WASI P2 includes these APIs](https://github.com/WebAssembly/WASI/tree/main/preview2#wasi-preview-2-contents), all available for use with wasmCloud 1.0:
