...
First, we need to install the latest version of `wash` (**`2.0.0-rc.7`**). If you've already installed `wash`, skip ahead to [Choose your language](#choose-your-language).
...
:::note[In progress]
Instructions for Go are in progress and will be available soon.
:::
