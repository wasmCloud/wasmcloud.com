...
```shell
wash -C ./ new https://github.com/wasmCloud/wasmCloud.git --name hello --subfolder examples/rust/components/http-hello-world
```
...
* The `-C ./` options tells `wash` to create the new project in our current directory. 
...
```shell
wash -C ./ new https://github.com/wasmCloud/typescript.git --name hello --subfolder examples/components/http-hello-world
```
...
```shell
wash -C ./ new https://github.com/wasmCloud/wasmCloud.git --name hello --subfolder examples/tinygo/components/http-hello-world
```
