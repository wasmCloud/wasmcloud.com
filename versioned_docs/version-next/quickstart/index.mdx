...
```shell
wash new https://github.com/wasmCloud/typescript.git --name http-hello-world --subfolder templates/http-hello-world --git-ref v2
```
...
```text
OK Successfully written dist/http_hello_world.wasm.
...
The TypeScript code for our component is found in `component.ts`.

Open the file in your code editor and change the "Hello" message on line 8. You might change the message into a greeting from WebAssembly, your own name, or whatever else you like.
...
addEventListener('fetch', (event) => {
  ...
  fetchEvent.respondWith(new Response('Hello from Wasm!\n')); // [!code ++]
});
```
