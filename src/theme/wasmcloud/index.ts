declare module '@theme/wasmcloud/components/video-modal' {
...
declare module '@theme/wasmcloud/hooks/use-click-outside' {
  export * from '@site/src/theme/wasmcloud/hooks/use-click-outside';
}

declare module '@theme/wasmcloud/hooks/use-keypress' {
  export * from '@site/src/theme/wasmcloud/hooks/use-keypress';
}
