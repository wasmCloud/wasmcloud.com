...
const FeatureList = [
  {
    ...
    image: { name: 'cloud', alt: 'Multiple type of devices around wasmCloud logo' },
    imageFirst: true,
    description: (
      <>
  ...
  },
  {
    ...
    image: { name: 'connected', alt: 'A message bus connecting multiple wasmCloud hosts' },
    imageFirst: false,
    description: (
      <>
...
function FeatureImageComponent({ image }) {
    ...
    return (
        <img className={styles.featureSvg} src={root 
            + '/feature-' 
            + image.name 
