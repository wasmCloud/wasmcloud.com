...
![wasmCloud Innovation Day](../../../static/pages/home/innovation-day/innovation-day.png)
...
<div style={{ display: 'table', width: `1200px`, paddingTop: '20px' }}>
...
- **Secrets: [Brooks Townsend](https://github.com/brooksmtownsend)**
    - Why this is the most requested feature amongst our enterprise customers and partners
- **Evolution in Golang: [Lucas Fontes](https://github.com/lxfontes), [Brooks Townsend](https://github.com/brooksmtownsend)**
    - Go provider SDK; Go components with TinyGo
- **wasmcloud-operator: Lucas Fontes**
- **wash dev: [Taylor Thomas](https://github.com/thomastaylor312)**
- **Custom Capabilities**
    - Postgres and Couchbase with [Victor Adossi](https://github.com/t3hmrman); Machine Learning with Christoph Brewing, BMW / Jochen Rau, MachineMetrics
...
- **12.15 - 12.30: Fireside Chat:** Community leaders in the CNCF and Bytecode Alliance join [Bailey Hayes](https://github.com/ricochet)
    - What’s next in cloud native WASI proposals?
    - Your Community Needs You! Bytecode Alliance community call to action
- **Customer and User Demos**
...
- Workshop! Build your own standup app with Lachlan Heywood
...
**6pm: Event Closes**
    ...
    <div style={{ float: 'right', width: '55%' }}>
        <a href="#" class="button" style={{ display: 'block', width: '200px', margin: '20px', fontSize: '18px' }}>Register</a>
        <a href="/contact" class="button" style={{ display: 'block', width: '200px', margin: '20px', fontSize: '18px' }}>Get in touch</a>
        <a href="https://twitter.com/intent/tweet?text=Join%20me%20at%20wasmCloud%20Innovation%20Day%20on%20Sept.%2018%20for%20a%20free%2C%20one-day%20virtual%20immersion%20course%20in%20WebAssembly%20and%20wasmCloud!%20https%3A%2F%2Fwasmcloud.com%2Finnovation-day" class="button" style={{ display: 'block', width: '200px', margin: '20px', fontSize: '18px' }}>Share on X</a>
        <a href="https://www.linkedin.com/feed/?shareActive=true&text=Join me at wasmCloud Innovation Day on Sept. 18 for a free, one-day virtual immersion course in WebAssembly and wasmCloud! https://wasmcloud.com/innovation-day 
" class="button" style={{ display: 'block', width: '200px', margin: '20px', fontSize: '18px' }}>Share on LinkedIn</a>
    </div>    
</div> 
