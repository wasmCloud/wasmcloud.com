...
- Main file, the code is simple - turns a Go binary into a provider.
- KV interface works seamlessly with WASI key-value.
...
- Simple steps: generate a new capability provider and point to the Go SDK.
- Readme prerequisites: Install Go Capability Provider, wit-bindgen, wRPC and wash.
- You can build using regular Go tools.
...
**Jorge: Is there a how to guide to build a provider?**
...
- [Ship it!](https://changelog.com/shipit) This Friday, Bailey and Taylor will chat about the process of getting WASI 0.2 and the Component Model into the wild and the process the wasmCloud team went through to integrate these new standards. 1pm ET.
