...
**Brooks Townsend** [00:13](https://youtu.be/vTbKtMkWxBQ?t=13)

Let me grab some water really quick before we do the thing. Yeah, I'll make you the host. We'll get started in just a minute or two — until five after, since all meetings run over.

**Frank Schaffa** [01:45](https://youtu.be/vTbKtMkWxBQ?t=105)

It's been a long time. Glad I could finally jump in.

**Brooks Townsend** [01:51](https://youtu.be/vTbKtMkWxBQ?t=111)

Yeah, it has been a little while. Good to see you.

**Brooks Townsend** [02:33](https://youtu.be/vTbKtMkWxBQ?t=153)

So for the agenda today, I'll be doing various levels of deep dives into what we're proposing as the beginning of **wasmCloud V2**, a.k.a. wasmCloud Next. The naming version isn't really important, but the key discussion is going to be around what Bailey said — I really liked how Bailey phrased this: "radical simplification." So, simplifying the APIs that we use, really trying to focus in on what wasmCloud does well. I think I have a pretty good starting-off point for that, and we'll just start talking about features that need to make it in there. I've got some architecture diagrams, I've got some code I'm going to bring up here, and I'm going to be talking about documentation, which Eric has been working on under a `next` version. So, all exciting stuff.
