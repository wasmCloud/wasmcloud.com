...
**Brooks Townsend** [00:11](https://youtu.be/rZSZ87g_82M?t=11)

So I haven't started the recording yet or anything. Let me make you a co-host. I was thinking that I would talk a little bit through the event sourcing repo — like the WIT that I have — and how I was talking with you, and we were talking about doing this thing, so I did this little POC. Then I thought I'd hand it over to you to do the whole spiel and what you think about it. How does that sound? Do you want to just take it from the start and talk about the work you've been doing? Because that's what I'm really more interested in showing off.

**Yordis Prieto** [00:58](https://youtu.be/rZSZ87g_82M?t=58)

The trick of it is that it depends, because WebAssembly is there to support things at the platform level — once you extract away from the problem. But most of the stuff I've already made isn't wasmCloud-specific; it's WebAssembly, WIT, that kind of thing. So it depends on what you want to get out of the conversation. Now, the conversation I'm having with — what's his name, Luke? — yeah, with Luke, will make WIT a step closer to what I need from the platform.

**Brooks Townsend** [01:38](https://youtu.be/rZSZ87g_82M?t=98)

I'm most interested in showing off a really cool use case for WebAssembly. The way you've approached it, whether or not it ended up being done with components from the start — that's something you're working on now — so you can always talk about the pros and cons there too.

**Yordis Prieto** [02:01](https://youtu.be/rZSZ87g_82M?t=121)

I can present a few examples for people to see what to expect when it comes to event sourcing. Let me get the repo ready for you. Also, don't ask me to run it, because the WebAssembly side isn't running — I destroyed the repository. It's literally just a lot of experimentation, just to figure out the final outcome I want.
