...
- Demo
  ...
  - Follow up discussions included details about lattice invocation round-robining, how wadm does reconciliation, and rollout strategies
    - Information about the lattice can be found [here](https://wasmcloud.com/docs/v1/concepts/lattice/), around how the network can handle new wasmCloud hosts, terminated wasmCloud hosts, and round-robin requests between available compute
...
- Actor discussion
  ...
  - Our current [Actor Documentation](https://wasmcloud.com/docs/v1/concepts/) for reference
