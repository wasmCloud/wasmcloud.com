...
- Recommended: SPIFFE Workload Identity for wasmCloud workloads; Joonas and Colin's talk was a highlight - watch this 
- Brooks showed the demo that we shared at the show - as always it's difficult to 
- Demo shows what it's like to build an application with wasmCloud. A really clear view of what wasmCloud 
