...
**Brooks Townsend** [00:04](https://youtu.be/mkMOpNQXGAE?t=4)

Hey, how's it going, everybody? Also, heads up — hey, Mike, welcome. It's not actually recording yet, we just use that for the trend. We'll go live here in like a couple of minutes. Hi guys. Hey, Florian.

**Mike Nikles** [00:34](https://youtu.be/mkMOpNQXGAE?t=34)

Hello, hello.

**Brooks Townsend** [00:37](https://youtu.be/mkMOpNQXGAE?t=37)

Alrighty, I can hear you. I'm gonna go ahead and make you — if you want to do a pre-flight check, I'm going to make you co-host so that you can share when it comes time, unless you just want to wave and describe the architecture.

**Mike Nikles** [00:52](https://youtu.be/mkMOpNQXGAE?t=52)

Yeah, I do need to share my screen. Okay.

**Brooks Townsend** [01:00](https://youtu.be/mkMOpNQXGAE?t=60)

Well, hey — like I said, we'll get started in a minute or so, but thanks for coming on. I'll just intro the call and then hand it over to you for a full introduction and how you came across wasmCloud and what you're building. But the floor is totally yours after that. Does that sound good? Let me grab a water real quick, and then I'll be right back. Colin, good to see you.

**Colin Murphy** [01:45](https://youtu.be/mkMOpNQXGAE?t=105)

I see you.

**Brooks Townsend** [01:50](https://youtu.be/mkMOpNQXGAE?t=110)

We'll give folks just another couple of minutes or so, and then we will do the thing.

**Colin Murphy** [02:20](https://youtu.be/mkMOpNQXGAE?t=140)

How's it going? Since we haven't started yet — I'm looking forward to the new things that are coming. I thought it was happening a while ago, so I was like, oh, hold off, work on something else, wait for the new stuff to go in, then dive into it. Shouldn't have taken the optimistic estimates so at face value.

**Brooks Townsend** [02:59](https://youtu.be/mkMOpNQXGAE?t=179)

We're actually doing a Cosmonic off-site this week, so we have a lot of people in the same room.

**Colin Murphy** [03:03](https://youtu.be/mkMOpNQXGAE?t=183)

Are you off-site this week? Wasn't there — is this like a three-week off-site? I swear, the last time I talked to Liam, there was an off-site.

**Brooks Townsend** [03:15](https://youtu.be/mkMOpNQXGAE?t=195)

No, we did do an off-site really recently — okay, maybe months ago, so that was good. This one, we are all together and got some new people joining Cosmonic, which is fun, and we're going to be doing some roadmapping. So we'll probably end up talking about it next week, or in two weeks or so.

**Colin Murphy** [03:40](https://youtu.be/mkMOpNQXGAE?t=220)

Yeah, no, I know — I don't want to be talking about things I shouldn't be talking about, but I'm just looking forward to the stuff that's being worked on.

**Brooks Townsend** [03:48](https://youtu.be/mkMOpNQXGAE?t=228)

Yeah. Well, hey, let's go ahead and do the thing. I'm going to start with the recording and just give a little spiel, and then I'll share the agenda, even though there's only the one thing on the agenda, and then Mike, I'll hand it to you.
