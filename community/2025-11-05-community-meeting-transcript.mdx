...
**Flynn** [00:22](https://youtu.be/FbLNlZgzWOU?t=22)

Bailey, it's too early to show you the print that is printing, but this is the one that ended up being slightly the wrong size, so it has to be reprinted.

**Bailey Hayes** [00:31](https://youtu.be/FbLNlZgzWOU?t=31)

Is it going to be for the booth?

**Flynn** [00:33](https://youtu.be/FbLNlZgzWOU?t=33)

Yeah, for the Linkerd kiosk. By the Linkerd kiosk you'll get to try to hit buttons at the right time to crash a cluster that Linkerd is doing its level best to keep running.

**Bailey Hayes** [00:46](https://youtu.be/FbLNlZgzWOU?t=46)

That sounds very fun. We've been thinking about doing an arcade-style theme. We're not going to make it this KubeCon, but maybe next KubeCon. We've got a guy on our team who builds pinball machines.

**Flynn** [00:58](https://youtu.be/FbLNlZgzWOU?t=58)

Oh man, yeah, we should talk. It's been entertaining. And there will be blinking lights at the kiosk.

**Bailey Hayes** [01:19](https://youtu.be/FbLNlZgzWOU?t=79)

Gotta have a pizzazz. Oh, and I got an extension for the WasmCon deadline — I'll bring this up on the call, but if folks want to submit another talk, I've got a special extension link for you for KubeCon. I'm a little worried this KubeCon is going to be a little sparse because of flights, potentially.

**Flynn** [01:45](https://youtu.be/FbLNlZgzWOU?t=105)

You mean Atlanta?

**Bailey Hayes** [01:46](https://youtu.be/FbLNlZgzWOU?t=106)

Yeah, the Atlanta one. I get a little nervous.

**Flynn** [01:51](https://youtu.be/FbLNlZgzWOU?t=111)

I am expecting that we will have a rather lightly attended KubeCon in Atlanta. We will find out.

**Bailey Hayes** [02:06](https://youtu.be/FbLNlZgzWOU?t=126)

Yeah, we will literally find out. Because — hey folks, Flynn and I are going to be giving a talk together. It's gonna be a lot of fun. It's coming together right now.

**Flynn** [02:36](https://youtu.be/FbLNlZgzWOU?t=156)

It was fun to show up the other day and have Bailey go, "oh yeah, this just worked." It was awesome.

**Bailey Hayes** [02:45](https://youtu.be/FbLNlZgzWOU?t=165)

I'm gonna say that in the talk too, for what it's worth. I literally just added an annotation — I had to, thank goodness you told me to make sure it's on the pod template. My first instinct was, "hey ChatGPT, what command would I run to add this imperatively via kubectl?" And it definitely did not do the right thing. Then I remembered Flynn told me to look for this, and so I fixed it.

**Flynn** [03:11](https://youtu.be/FbLNlZgzWOU?t=191)

I would love to tell you that I have never made that mistake myself — certainly not on multiple occasions recently. And for anybody else on the call: if you're trying to annotate the pods controlled by a deployment, annotate the deployment.
