...
- **HTTP requests do not go through NATS in v2.** This is a deliberate change from v1 for performance reasons — described in detail in Eric's [migration to v2](https://wasmcloud.com/docs/v2/migrate-to-v2/) doc, which Bailey called out as a recurring "doc of the week" pattern worth highlighting.
