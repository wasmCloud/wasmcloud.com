...
- Doc of the Week: Updates to the [wash new CLI](https://wasmcloud.com/docs/v1/cli/wash/) page, clarifying different ways to use templates.
...
- [Add #[instrument] macros to the custom-template-rust provider](https://github.com/wasmCloud/wasmCloud/issues/2402) - good first issue
...
- Updates to the [wash new CLI](https://wasmcloud.com/docs/v1/cli/wash/) page, clarifying different ways to use templates - Eric
...
<YouTube url="https://www.youtube.com/watch?v=239Q_hAKqPw" />
