...
A couple of great posts have appeared on the CNCF blog recently…take a look!
...
- Useful [White Paper] on Webassembly with multi-cloud platforms co-authored by Liam and the folks at Red Badger [content.red-badger.com/resources/white-paper-multi-cloud-platforms-are-here-how-webassembly-nats-and-wasmcloud-move-us-beyond-cloud](http://content.red-badger.com/resources/white-paper-multi-cloud-platforms-are-here-how-webassembly-nats-and-wasmcloud-move-us-beyond-cloud)? 

**Tune in…**

- Taylor will join Dotan Horovitz for the Open Observability Talks podcast to discuss all things WebAssembly, and how it is the next frontier in the evolution of cloud native computing. [Join next Thursday, July 18th, 2pm ET[(https://www.youtube.com/watch?v=t2xIoVNwtKM).
