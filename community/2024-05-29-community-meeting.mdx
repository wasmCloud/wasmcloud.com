...
- Robin: aren't some of these implemented by postgres extensions? Is there a distinction being made between "core types" (or whatever they're called) and extension types and a way being provided to extend these?
...
**Q: Colin Murphy**
- Consideration; what happens when don’t want every execution of a Wasm to connect to a Vault.
