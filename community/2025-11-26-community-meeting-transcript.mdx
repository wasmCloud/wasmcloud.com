...
**Bailey Hayes** [00:51](https://youtu.be/tf5z_K4krfM?t=51)

Hello. We've got some more doc updates incoming that were based on the conversations we had last week, and that's in pull request form right now on the wasmcloud.com repo, Lucas, if you want to give that a look. Eric took a pass at an FAQ there.

**Aditya** [02:41](https://youtu.be/tf5z_K4krfM?t=161)

I had a question to ask you, Bailey.

**Bailey Hayes** [02:44](https://youtu.be/tf5z_K4krfM?t=164)

Yeah, sure. We're officially starting in two minutes. Do you want it on the live stream, or do you want it before? I think before.

**Aditya** [02:57](https://youtu.be/tf5z_K4krfM?t=177)

Oh, okay, yeah. So I think you talked with Chris about **wasi-tls**, and I'm planning to implement it in Wasmtime. So I was wondering if you had any pointers regarding that.

**Bailey Hayes** [03:11](https://youtu.be/tf5z_K4krfM?t=191)

Yeah, okay. So first off, a version of wasi-tls is already implemented in Wasmtime, so good news there. It's already being consumed by the C#/.NET team. One of the things that's slowing us down on wasi-tls is that folks are focused on P3 — basically the problem is that wasi-tls wasn't part of P2, and the folks working on P3 are the same folks who were behind wasi-tls, but they haven't prioritized it over their P3 work, which is fair. My concern about downstream consumers depending on wasi-tls now is that there's a ticket — I think Chris maybe sent it your way — and in that ticket there are three design changes they want to make. So what I suggest is going ahead and making a change first to the WIT to make sure it addresses that person's design changes, then taking that WIT definition and implementing it inside Wasmtime. Colin, who's actually a maintainer on wasmCloud as well, from Adobe, has a guide inside the Wasmtime book on how to add new WIT interface support inside Wasmtime.

**Aditya** [04:38](https://youtu.be/tf5z_K4krfM?t=278)

I don't see the phase-one implementation in Wasmtime — give a lot of context around that.

**Bailey Hayes** [04:46](https://youtu.be/tf5z_K4krfM?t=286)

I think it should just be a matter of updating it a little bit. We also should go ahead and aim for getting a P3 version of that interface done. For that, I recommend looking at the **wasi-sockets** P3 draft. And if you're looking for dead links, I did this massive migration yesterday — it's all inside the WebAssembly WASI repo now, if it's a phase-three proposal.

**Aditya** [05:12](https://youtu.be/tf5z_K4krfM?t=312)

All right, I'll take a look at it. Thank you very much. I did reach out to the person who wrote the proposal, and I've asked him to address the questions that Joel had on that.

**Bailey Hayes** [05:42](https://youtu.be/tf5z_K4krfM?t=342)

Yeah, Joel is both the champion and probably the person who would code review your changes, so he's definitely the right person to talk to. Okay, I'm going to get started. Liam, all you have to do is hit the button — I have the ability to share as co-host, which is fine, but you've got to do the custom live stream thing.

**Liam Randall** [06:04](https://youtu.be/tf5z_K4krfM?t=364)

You have the conn. Okay.
