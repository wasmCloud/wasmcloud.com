...
* Brooks provided some background on **composing WebAssembly components**. Refer to the wasmCloud docs for [Linking at Build](https://wasmcloud.com/docs/concepts/linking-components/linking-at-build/) for more information. 
