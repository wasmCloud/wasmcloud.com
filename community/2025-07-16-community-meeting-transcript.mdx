...
**Brooks Townsend** [00:16](https://youtu.be/cNovOusQE7M?t=16)

Jeremy, one thing that we usually like to do — we'll start the live stream here in a second, but we like to give people a chance to introduce themselves. Would you be interested in doing that when we get started? I'll just give a little intro spiel, and then I'll hand it to you to say whatever you want. We'll give folks until about 1:05 or so to come hang out.

**Jeremy Fleitz** [00:32](https://youtu.be/cNovOusQE7M?t=32)
...
<img src="/img/community/2025-07-16/image014.webp" alt="The issue of the week: wash uses model.list which triggers a wadm deprecation warning" />
