...
- If you are overriding your endpoint this shoudn’t affect you but this is something we fixed in the host so that based on the URL you provide will append the v1 or cut it off (GRPC end point).
...
- New versions of all capability providers to absorb changes.
...
- A group of telcos has been working with wasmCloud to explore whether it can replace Kubernetes to handle ODA components.
- If you’re interested in learning more about the TM Forum WebAssembly Canvas Catalyst project, tune in to their recent [Wasm Day talk](https://www.youtube.com/watch?v=fQdkNGZqYZA&list=PLj6h78yzYM2MQteKoXxICTWiUdZYEw6RI&index=7).
- This is the 2nd year - and the new mission is looking at a unified orchestration methodology for highly distributed applications. Which is why wasmCloud is perfect for the use case.
