...
- DEMO: Blobby example
- wasmCloud v2 updates: build commands
...
- [v2 Glossary](https://github.com/wasmCloud/wasmcloud.com/pull/1048)
  - v2 Glossary with entries for "Service" and "Workload"
- [Installation page re-work](https://github.com/wasmCloud/wasmcloud.com/pull/1049)
