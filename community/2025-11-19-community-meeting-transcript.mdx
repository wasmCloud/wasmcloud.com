...
**Frank Schaffa** [00:46](https://youtu.be/EqvKzu-e9gw?t=46)

You going to talk about your C++ thing today?

**Bailey Hayes** [00:49](https://youtu.be/EqvKzu-e9gw?t=49)

No, I queued up other people to talk. I can demo it, though — sorry. My changes are all actively landing right now.

**Yordis Prieto** [01:00](https://youtu.be/EqvKzu-e9gw?t=60)

Maybe save it for next week. I thought it was super cool.

**Frank Schaffa** [01:03](https://youtu.be/EqvKzu-e9gw?t=63)

It's pretty cool. Yeah, we've got time.

**Bailey Hayes** [01:23](https://youtu.be/EqvKzu-e9gw?t=83)

Yeah. So as usual, we get started five minutes after the hour, so I'm not hitting the hidden live stream yet — just dropping some of the items we want to cover. Hello. Hey, is that you, Masoud? Yeah, it is.

**ossfellow** [01:43](https://youtu.be/EqvKzu-e9gw?t=103)

How are you? Good. I hope you guys had fun at KubeCon. I have a suggestion. I think at some point we, as a community, need to talk about what — at least the outlines of it at this time — a migration from wasmCloud version one to version two means. As you can see from the questions that are coming up, there's quite a bit of confusion about how this is going to work, especially in a distributed environment. And if there are future plans, even if the features aren't in place yet, then at least providing those clarifications is going to help everybody have a better understanding of what the migration looks like.

**Bailey Hayes** [02:46](https://youtu.be/EqvKzu-e9gw?t=166)

Yeah, absolutely. We've actually had our real-world workload flows, so I think a doc is definitely in order. I also put together an arch diagram that I think helps spell out, "oh, it's all changing." Actually, no — the parts are just more broken up. But it's not necessarily a fundamental change where what you were doing before would no longer work today.

**ossfellow** [03:12](https://youtu.be/EqvKzu-e9gw?t=192)

And I understood this early on, that wadm is not in the picture. Right now you create a manifest that's really managed by wadm in v1, and now we're having workloads in v2 — and how this converges from one to the other, those sorts of high-level highlights are going to help the community.

**Bailey Hayes** [03:49](https://youtu.be/EqvKzu-e9gw?t=229)

Agree completely. I think we need to show, in a community call, on our documentation: "this is the workload spec. Look, you can see the migration path." We also had a little CLI Brooks wrote that takes a wadm spec and creates a workload spec. It just isn't completely one-to-one, so it's not perfect — but it's another good tool to put out there as a fast migration path, because it works for most cases. It's tricky when you do your own custom thing. Well, we're five minutes in, so — Eric, actually, before I hit that: Liam, will you make sure that Lucas and Eric have what they need?

**Yordis Prieto** [04:47](https://youtu.be/EqvKzu-e9gw?t=287)

Lucas, you're the host now. I'm the host now? Yeah, I logged in super early.

**Bailey Hayes** [04:53](https://youtu.be/EqvKzu-e9gw?t=293)

Eric, are you the host? Make sure you can share.

**Eric Gregory** [04:59](https://youtu.be/EqvKzu-e9gw?t=299)

Yeah, sure. I was just checking — looks like I can share.
...
<img src="/img/community/2025-11-19/image008.webp" alt="Bailey's sketch of the wasmCloud reconciler and host scheduling model" />
