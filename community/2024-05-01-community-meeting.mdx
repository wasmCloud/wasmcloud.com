...
- Also, check out our [documentation](https://wasmcloud.com/docs/v1/ecosystem/wash/plugins) and our [handy developer guide](https://wasmcloud.com/docs/v1/ecosystem/wash/plugin-developer/) if you want to tinker.
...
- We have updated our docs so you can [try things out](https://wasmcloud.com/docs/v1/ecosystem/wash/plugin-developer/) - toolchain section under wash (toggle 1.0). Configuration, disable, developer guide. 'wash-build' with the wash toolchain means your plugin will run anywhere as components.
