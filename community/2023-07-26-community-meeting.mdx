...
- There is a wasmCloud in production guide under the [wadm section](https://wasmcloud.com/docs/v1/deployment/wadm/#configuring-credentials) - talks through the process of working with NATS clusters.
...
<YouTube url="https://www.youtube.com/watch?v=b-B0XDJhs8U" />
