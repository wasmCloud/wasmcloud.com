...
- Refer to the [link definition documentation](https://wasmcloud.com/docs/v1/concepts/runtime-linking/link-definitions) for more detail
...
<YouTube url="https://www.youtube.com/watch?v=zT_HUMusMx8" />
