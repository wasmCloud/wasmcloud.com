...
**Brooks Townsend** [00:18](https://youtu.be/HclZChWxD40?t=18)

I read AI meeting notes. Who? Yeah, I—

**Liam Randall** [00:22](https://youtu.be/HclZChWxD40?t=22)

—saw that. It said in the chat. I was like, Mike added "read AI notes." I mean, I don't know who Mike is.

**Brooks Townsend** [00:31](https://youtu.be/HclZChWxD40?t=31)

Me neither. Well, Mike, sorry you're not getting your notes today, whoever you are. Hey, Elizabeth, we haven't started yet. Just a heads up — usually wait until a couple minutes after. Just to give you all a little preview: today we're going to let Elizabeth do a little intro for herself and the project that she's working on, whamm. It's a great name, such a great name. And then after that, I wanted to discuss pull request bankruptcy. I think we've got a bunch of pull requests out in the wasmCloud main repo that are basically getting held behind by a similar set of flaky tests. Every once in a while, Taylor, I know you do this — declare GitHub inbox bankruptcy and just delete everything. I think we should probably file a couple of issues for the tests that are bad and try to resolve those one at a time. We've had a lot of high-quality PRs sitting behind that merge button for a while, and I don't want to keep that happening. If we just identify the pattern, the real suggestion would either be to disable the need for the wasmCloud successful check to pass for a temporary time and merge things in through the merge queue, or disable the merge queue and just rebase.

**Liam Randall** [03:14](https://youtu.be/HclZChWxD40?t=194)

We'll talk about that soon. Anyway, we'll save it for the recorded portion.

**Brooks Townsend** [03:18](https://youtu.be/HclZChWxD40?t=198)

Yeah, and don't feel bad about pushing back on process. I'm not just trying to YOLO-merge everything, but—

**Liam Randall** [03:27](https://youtu.be/HclZChWxD40?t=207)

Oh no, I'll be behind this. We've gotta figure out what's actually going on.
