...
**Liam Randall** [00:54](https://youtu.be/CbE9Uzfkb2I?t=54)

This is probably the fourth different video conferencing technology I've been on today. Teams, Meet, and the thing we use internally — Gather. Sometimes they just adopt different perspectives. I'd even blur my background so you can spot me from all my baby stuff, but I don't know where to do that. If you click the video icon in the bottom-left on my Mac, there's a little up arrow, and your background is a function right there.

**Liam Randall** [01:48](https://youtu.be/CbE9Uzfkb2I?t=108)

I've got three kids, so you understand how hermit crabs live when you have kids. Going from one to two was a lot, and then going from two to three really didn't matter, because we were already drowning. I'm not really a helicopter parent — I believe everybody should live their life 20% uncomfortable. That's my personal philosophy, and certainly for my kids: jump off that 20-foot cliff, follow the instructions, get some scrapes and bruises. About 80% of the growth happens in that 20% of the discomfort. So I really push my kids to fail a lot. If you're not failing at stuff, you're not being ambitious enough. That's Brooks — you have the con now.

**Brooks Townsend** [03:37](https://youtu.be/CbE9Uzfkb2I?t=217)

Thank you. Basically the same thing as kids — dogs. Sometimes you have to take them to the vet, and sometimes that appointment's really fast, which is nice. Now Dougie is just chilling in the sun in his bed. This is the time of year where the sun streams into the back window.

**Brooks Townsend** [04:06](https://youtu.be/CbE9Uzfkb2I?t=246)

Thanks for being here, everybody — good to see Mike, good to see Colin, good to see Aditya. I think today should be fun. I've got some good updates for some of the bigger tickets on the roadmap. I promised a demo, but I just got back, so quite honestly it's going to be two discussions. But Bailey, you have a demo, right? Do you want slightly more time? You need ten? Okay, we'll do the demo later. This discussion should take us a good bit of the way, so it'll be fine. Let's do it.
