...
**Jeremy Fleitz** [00:04](https://youtu.be/iOjIbjWfYpM?t=4)

Hey, what's up?

**Brooks Townsend** [00:07](https://youtu.be/iOjIbjWfYpM?t=7)

Just just chill. Got a little coffee.

**Jeremy Fleitz** [00:14](https://youtu.be/iOjIbjWfYpM?t=14)

I got a blackberry citrus seltzer water.

**Brooks Townsend** [00:23](https://youtu.be/iOjIbjWfYpM?t=23)

I join the Legion of wasmCloud enthusiasts that are opinionated about their water bubbles.

Okay, give folks another couple minutes. I know that Aditya wanted to be here to talk about some issues, but we've got other stuff to do that we can discuss real quick — like `wash` and the setup-wash action — so it'll be quick. It's actually pretty quiet, though. Might just be a quiet one.
...
<img src="/img/community/2025-08-20/image003.webp" alt="The setup-wash GitHub Action repository and marketplace listing" />
