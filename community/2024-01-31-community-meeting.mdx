...
Note: check out our new website! Thank you so much Nik for all the work on [wasmCloud.com](http://wasmCloud.com) - we’re stoked.
...
- There was a wider discussion on wRPC - check out the [early modelling](https://github.com/rvolosatovs/wrpc/tree/main) Roman has been working on.
