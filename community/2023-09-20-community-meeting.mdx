...
- Implementing Prometheus metrics in wasmCloud:
  ...
  - Provider exposing metrics - counter for number of 500s/400s is pretty common. We want to be able to do the same thing in wasmCould.
...
<YouTube url="https://www.youtube.com/watch?v=7GR19pgb2u0" />
