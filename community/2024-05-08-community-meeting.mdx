...
**DEMO: wit-RPC Go implementation**
- It’s exciting to be able to talk about our Go implementations and so we have a couple of demos to show in this week’s community meeting.
...
- Tl;dr: the value encoding proposal is PR-ed upstream and is implemented it in multiple languages. What this means is the possible mix of multi-language tooling is endless.
...
**DISCUSSION: [Q2 Roadmap Review](https://github.com/orgs/wasmCloud/projects/7/views/10)**
- Thank you to all the community for your contribution to the roadmap discussion, and the suggestions seen since. Our [Q2 high level goals](https://github.com/orgs/wasmCloud/projects/7/views/10) are updated and ready to view.
- Several notable new RFCs in the plan which are priorities for the next season.
- New documentation, new feature, improvement buckets can be [viewed in Github](https://github.com/orgs/wasmCloud/projects/7)
...
- Lattice client rewritten so we have a way to do almost everything wash can do but through a JS library.
