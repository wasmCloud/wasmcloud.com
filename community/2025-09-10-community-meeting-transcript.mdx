...
**Brooks Townsend** [00:04](https://youtu.be/BtOseiHpgmk?t=4)

Hey, Brooks. Hey, Jeremy, how's it going? Good. Hey, nice polo. Thanks.

<img src="/img/community/2025-09-10/image001.webp" alt="wasmCloud Weekly Community Call participants on the September 10, 2025 Zoom" />

**Brooks Townsend** [00:16](https://youtu.be/BtOseiHpgmk?t=16)

Wow. I couldn't really see your cup. The way the window hit it, it almost looked like a stout — like a little Guinness. Now I kind of want one. It's five o'clock somewhere; it's the international meeting. I used to have an espresso machine with those little pods, and the mugs were clear glass, so it always looked like I was drinking a Guinness first thing in the morning back when I was on Critical Stack. Jason probably remembers that. Well, hey, Colin — this one is probably going to be a little short. I didn't actually have an agenda. I've been pretty heads-down on the runtime piece we talked about last week, like the wasmCloud host API, and Lucas has been working on the wasmCloud runtime operator, the Kubernetes operator.

**Colin Murphy** [01:40](https://youtu.be/BtOseiHpgmk?t=100)

Oh, yeah.

**Brooks Townsend** [01:42](https://youtu.be/BtOseiHpgmk?t=102)

It's actually open source, and we're just trying to figure out when to move it over.

**Colin Murphy** [01:46](https://youtu.be/BtOseiHpgmk?t=106)

So that's great. It'd be good — I know I don't know if it's more of a this-kind-of-meeting thing, but we'll have a good little review for it pretty soon. It's great. Are we going to stream this? Is it being streamed right now?

**Brooks Townsend** [02:09](https://youtu.be/BtOseiHpgmk?t=129)

It's not being streamed right now, but we will. It's just going to be really quick, and then we can chat after if you want.

**Colin Murphy** [02:15](https://youtu.be/BtOseiHpgmk?t=135)

That's okay. I guess I could chat after.

**Brooks Townsend** [02:20](https://youtu.be/BtOseiHpgmk?t=140)

Chat during too. But yeah, I think you may be interested — were you doing something like forking wasmCloud to add WASI WebGPU for a demo? It's upcoming.

**Colin Murphy** [02:37](https://youtu.be/BtOseiHpgmk?t=157)

Oh, yeah, I did. I did that. I added something. It isn't really the adding-to-wasmCloud part, because it looks like Wasmtime, right? So it's super easy to add the linker. But the actual getting all the calls of WebGPU mapped into an actual WASI — that's still ongoing.

**Brooks Townsend** [03:17](https://youtu.be/BtOseiHpgmk?t=197)

Yeah, you may be interested in some of the different surface API that the host can tap into, because you'd be able to do that without forking wasmCloud and going down to the runtime piece. There's a new facility for just providing a plugin. You'd have your little Rust binary, you embed the host — but we can talk about that later. All the work you're doing now to implement all those calls to the GPU, all of that carries over exactly. It's the same linker mechanism.

**Colin Murphy** [03:53](https://youtu.be/BtOseiHpgmk?t=233)

Oh yeah, I figured. I mean, ideally what I do for the talk is show it running completely in WebAssembly, and then also have it call to the ONNX runtime — running in a provider — just a pros-and-cons kind of thing.

**Brooks Townsend** [04:13](https://youtu.be/BtOseiHpgmk?t=253)

Yeah, sure. Okay, we can talk more later, but I'm just going to hop on. All right.

**Colin Murphy** [04:21](https://youtu.be/BtOseiHpgmk?t=261)

I'm going to go off video, at least.

**Brooks Townsend** [04:23](https://youtu.be/BtOseiHpgmk?t=263)

Don't do it. Don't make me alone.

**Colin Murphy** [04:25](https://youtu.be/BtOseiHpgmk?t=265)

I know, I feel bad. But I also hate seeing myself on video, so it's very difficult. You put me in quite a conundrum.
...
<img src="/img/community/2025-09-10/image002.webp" alt="Brooks Townsend kicking off wasmCloud Wednesday for September 10" />
